## 51 ダミーデータを View 側に表示

### EventController

```php:EventController.php
use Illuminate\Support\Facades\DB; // クェリビルダ
...
<tbody>
  @foreach($events as $event)
    <tr>
      ...
      <td class="px-4 py-3">{{ $event->end_data }}</td>
...
`resources/views/vendor/pagination/tailsiwnd.blade.php`を編集<br>
...
* `resources/views/vendor/pagination/tailwindcss.blade.php`を編集<br>

```php:tailwindcss.blade.php
