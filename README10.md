...
## 50 events/index.blade.php

`dashboard.blade.php`をコピーして中身は TailBlocks を参照<br>

https://tailblocks.cc/ <br>

Pricing2 つ目の表をコピーしてカスタマイズ<br>

(編集時は `npm run watch`で監視しつつ Google クロム開発ルールで CSS を見ながら調整する)<br>
